...
def getVesselDataComponentsDiametersLengths(img_name):

	initial_path = '/home/stolz/Desktop/Vessel Networks/Cambridge_Data/'
	img_path = initial_path + img_name + '.nii'

	min_branch_length = 0 #10
	min_object_size = 0 #100

	output_dir = '/home/stolz/Desktop/Vessel Networks/Cambridge_Data/' +img_name+ '/'
	skeleton_path = output_dir + 'skeleton.pkl'
	...
	vt.plot_vessels(metric='diameter', metric_scaling=10, write_location=output_dir + "diameterPlot.png", width_scaling=2)
	vt.plot_vessels(metric='length', metric_scaling=1, write_location=output_dir + "lengthPlot.png", width_scaling=2)
	vt.plot_vessels(metric='clr', metric_scaling=255, write_location=output_dir + "clrPlot.png", width_scaling=2)
