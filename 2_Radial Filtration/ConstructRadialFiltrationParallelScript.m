...
parfor data_file_number = 1:length(tumours)
    ...
    [starts_dim0, ends_dim0, starts_dim1, ends_dim1] = getRadialFiltrationParallelZ(initial_path, folder, category, tumour, day, file_id, output_path, number_of_divisions);
