...
parfor data_file_number = 1:length(tumours)
    ...
    if data_file_number < 118
    
        initial_path_file = char(initial_path);
        
    else
        
        initial_path_file = char(initial_pathII);
        
    end

    output_path = '/home/stolz/Desktop/Vessel Networks/unet-test-master/Data Bostjan Output/Skeleton Output/GUDHI/input/';
